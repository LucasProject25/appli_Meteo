...
## L'API
Cette application utilise une [API](https://openweathermap.org/forecast5?collection=current_forecast) (non officiel), du [site](https://openweathermap.org/) OpenWeather, permettant de récupérer plusieurs informations sur la météo des villes du mondes en temps réel.
